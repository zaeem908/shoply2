    ...
    <div>
      <header className="bg-gray-200 py-4">
           <ul className="flex space-x-10 items-center justify-center">
            ...
            <Link to={'/cart'} className=" w-[3rem] h-[3rem] hover:bg-gray-400 p-2 rounded hover:text-white"><img alt='img' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSN3wAcYgtK2nz6SBIK0EZUfs9Tv8nv9V5l8g&usqp=CAU'></img></Link>
           </ul>
      </header>
    </div>
  )
